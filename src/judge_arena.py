...
PROMPTS = {
    ...
    "st_reason": {
        ...
        "question": "这份「被实施风险警示」公告里，触发戴帽的原因属于哪一类？选项："
                    "A=治理/合规类（内控被否·行政处罚·账户冻结·资金占用·违规担保）B=纯财务类（收入/净资产指标·净利润为负）"
                    "C=重整/破产 D=说不清（正文里只有规则条文引用或没写原因）",
        "schema": {"choice": "A|B|C|D", "probability": {"A": "0..1", "B": "0..1", "C": "0..1", "D": "0..1"},
                   "confidence": "0..1"},
        "truth_map": {"合规/治理类": "A", "财务类": "B", "重整/破产": "C", "未归类": "D"},
    },
}
